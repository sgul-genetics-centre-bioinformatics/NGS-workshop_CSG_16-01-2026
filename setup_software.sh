...
ln -s /homes/athosnew/Genetics_Centre_Bioinformatics/NGS_workshop_bioinformatics_unit_31_01_2020_software/Genome_reference_files/common_all_chrM.vcf.gz.tbi Genome_reference_files/common_all_chrM.vcf.gz.tbi
